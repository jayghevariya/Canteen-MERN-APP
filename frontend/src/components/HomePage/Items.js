...
const Item = ({ prop,SearchItem,setSearchItem,age,setAges } ) => {
    ...
    //   </tr>
      ...
      <div class="card-body">
        ...
        <button href="#" class="btn btn-primary" onClick={change}>More</button>
        <button class="btn btn-outline-warning heartbtn" onClick={add}><i className="fa fa-heart"></i></button>
